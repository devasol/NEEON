...
const Login = ({ noContainer = false, onClose }) => {
    ...
    <div className={styles.loginCard}>
      {onClose && (
        ...
        <div className={styles.backgroundElements}>
          <div className={styles.floatingCircle} style={{ '--delay': '0s' }}></div>
          <div className={styles.floatingCircle} style={{ '--delay': '1s' }}></div>
          <div className={styles.floatingCircle} style={{ '--delay': '2s' }}></div>
          <SparkleIcon />
        </div>
          ...
          <div className={styles.inputGroup}>
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                className={`${styles.input} ${errors.email ? styles.error : ''} ${isFocused.email ? styles.focused : ''}`}
                placeholder=" "
                disabled={isLoading}
              />
          ...
          <div className={styles.inputGroup}>
            <div className={styles.inputContainer}>
              ...
              <input
                ...
                className={`${styles.input} ${errors.password ? styles.error : ''} ${isFocused.password ? styles.focused : ''}`}
                placeholder=" "
                disabled={isLoading}
              />
  ...
  return (
    <div className={`${styles.loginContainer} ${animate ? styles.animate : ''}`}>
      {card}
    </div>
  );
};
